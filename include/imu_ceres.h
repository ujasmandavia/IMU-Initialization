...
};  //class InertialCostFunction


class BiasPriorCostFunction : public ceres::SizedCostFucntion<3,3>{
public:
  BiasPriorCostFucntion(const double variance, cosnt Eigen::Vector3d& mean = Eigen::Vector3d::Zero()) : weight(std::sqrt(variance)), mean(mean) {}

  virtual ~BiasPriorCostFucntion() {}
